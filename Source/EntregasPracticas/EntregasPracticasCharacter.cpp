...
{
	// Calculamos desde d�nde y hacia d�nde va el rayo (Line Trace)
	...
	// Lanzamos el rayo invisible para detectar qu� tenemos enfrente
	...
	if (bHit)
	{
		...
		{
			// Ejecutamos la funci�n Interact de la interfaz. 
